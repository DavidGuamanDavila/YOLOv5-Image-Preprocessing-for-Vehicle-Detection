...
def main():
    ...
    input_test_image_path = '' # TODO: Replace with actual input image path once determined
    weights_path = '../YOLOv5_Files/best.pt'
    output_image_path = '' # TODO: Replace with actual output image path once determined
